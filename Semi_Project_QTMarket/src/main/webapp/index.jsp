...
<body>
	...
	<main class="main">
		...
		<section id="home" class="section">
			<div class="home section__container">
				...
				<img src="${ path }/resources/imgs/logo.png" alt="logo"
					class="home__logo__image" />
			</div>
		...
		<footer id="footer">
			<div>
				<p>
					<a href="${ path }/QT/aboutus" class="footer__au">about us</a>
				</p>
			</div>
			<div>
	...
	<script>
    <c:if test="${ !empty loginMember }">
		let name = "${loginMember.name }".substring(1,3) + "님이" ;
	</c:if>
	<c:if test="${ empty loginMember }">
		let name = "당신이";
	</c:if>
